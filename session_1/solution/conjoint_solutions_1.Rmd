...
4. How can the respondent-varying charateristics can be identified?
5. Do we have any info on the 'quality' of the data?


```{r, echo=T, message=FALSE, warning=FALSE}

kc_data <- readr::read_csv("data/Kirkland_Coppock_mturk_replication.csv")
...
The number or rows is the total nuber of observatons uses for the analysis.
