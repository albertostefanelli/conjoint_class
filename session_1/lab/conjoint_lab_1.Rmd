---
title:  Intro to Conjoint Experiments | LAB - Session 1
...
3. Get the data ready for the analysis 
  1. Validity checks
  2. From Wide to Long
...
df_base <- qualtRics::read_survey("data/experimental_political_science_2018.csv", # name of our data file
...
- The similarity in the % suggests that a specific subet of respondets did not complete the survey
