...
- Lecture's PDFs
- Lab Session (from Session 2)
- Solutions (from Session 2)
...
- Make sure the conjoint design program works
- Make sure to register on 000webhost.com 
- Make sure R works (for tomorrow)
- Make sure to have access to the Qualtrics account (for tomorrow)
...
2. Terminology (many terms that refers to same phenomena)
...
3. Even when using semi-experimental techniques, **No causation without manipulation**. 
