...
2. Display high(er) levels of validity 
    ...
    3. Measurement quality: respondents are found to be consistent even for quite complex tasks [e.g., @bansak_beyond_2019]
...
1. Identify and define the **levels**   
    ...
    4. Avoid attributes ambiguity 
        1. E.g., "High level of integrity" of a candidate VS "Never indicted for corruption"  
...
1. Internal Validity: **garbage in, garbage out"**
    ...
    2. **Satisficing** [@bansak_beyond_2019]
        1. Disregard substantive information due to high cognitive complexity. 
...
3. **Outcome** measures 
    1. Discrete choice (better for trade-offs)
    2. Individual ratings (better for detecting extreme response style)
4. **Randomization**
