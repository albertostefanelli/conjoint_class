...
4. As such, involves trade-offs (e.g., Male Republican VS Female Democrat)
    1. The possibility that option A (Donald Trump) is better than option B (Hilary Clinton) on attribute Gender (Male) while B is better than A on attribute PID (Republican). 
...
1. Respondent’s preferences are measured without putting them in a broader context
    ...
    2. E.g. a voter may evaluate a particular policy position differently depending on the other policies with which it is bundled in the proposed party platform.
...
1. Evaluate the relative explanatory power of different theories, moving beyond tests of a single hypothesis
    ...
    2. E.g., is ideology or party identification 
...
2. Display high(er) levels of validity 
    ...
    2. Measurement quality: respondents are found to be consistent even for quite complex tasks @
3. Reduce social desirability biases such as vote for female political candidates [e.g., @teele_ties_2018] and opposition to construct a low-income housing project in respondent’s neighbourhood [e.g., @hankinson_when_2018].
...
3. Clear differentiation between most-preferred and least-preferred profiles 
...
## Basic terminology in Choice Based Conjoint (1/2)
...
## Basic terminology in Choice Based Conjoint (2/2)
...
1. Internal Validity: **garbage in, garbage out"**
    ...
    2. **Satisficing** [@bansak_beyond_2018]
...
4. Terminology
    ...
    - Levels: characteristics of the different alternatives
