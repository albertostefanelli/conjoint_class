...
2. Explicitly control the target of the inference to be especially plausible
...
2. Does not require a particular behavioral model for respondents’ decision-making processes
    - Respondents might be maximizing utility, be boundedly rational, they might use weighted adding, l        exicographic, or satisficing decision strategies and the AMCE is still valid
...
1. **Not** a general measure of preference of certain attributes
    ...
    -  **Not** the probability of a female candidate being chosen against a randomly generated male candidate.
...
2. **Not** able to separate priority ranking and preference intensity. In actual decisions, these two steps are inseparably connected in respondents’ minds. 
    - the AMCE represents both preference towards a particular profile and intensity of such preference [@bansak_using_2023].
3. **Not** that candidates with feature A beat candidates with feature B in most elections
4. Example: 
