...
1. From the paper "The Ties that Double Bind"
...
- Variables in the dataset
    ...
    - PCandidate's olitical Experience= "orig_0ys", "orig_1ys", "orig_3ys", "orig_8ys"
...
# load the data 
teele_data <- readr::read_csv(sprintf("https://drive.google.com/uc?export=download&id=1ZFbtJ6_kCy4-JH6p9McikXvS1YfOgvcl"
