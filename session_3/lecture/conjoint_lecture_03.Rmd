...
1. Full Factorial 
    1. All possible combinations of levels
2. Fully randomized design 
    1. **Fully randomized uniform design**
        1. Equal probability of all levels in a given attribute
        2. E.g., Female 33%, Male 33%, Non-Binary 33%
    2. **Randomized weighted design**
        1. Unequal probability of certain levels in a given attribute 
        2. Marginal distribution of levels departs from uniform distribution 
        3. E.g. Female 50% and Male 49%, Non-Binary 1%
    3. **Restricted Randomization (or nested design)**
        1. Certain combinations or attributes are not allowed to happen
        1. E.g., Doctor without academic degree 
...
6. If we assign approximately 20 respondents per each combination 
7. $729*20= 14000$

# Randomized design  

1. Developed by @hainmueller_causal_2014 relaying upon the potential outcome framework 
...
## Restricted Randomization (or nested design) (1)

1. Sampling performed in the same way as the fully randomized design 
2. **BUT** we impose limitation on the combination of certain attributes within a profile. 
3. Technically, we set the conditional probability of the co-occurrence of two attributes/levels equal to zero
4. Meaning, we deny that two (or more) unlikely or contrasting combination of attributes/levels from appearing together
...
3. Randomization of the profiles 
    - The potential choice can never be systematically related to what profiles they will actually see in the experiment. 
...
3. Include a mid-point (i.e. Neither agree nor disagree) [@nadler_stuck_2015]
...
6. When questions are similar, use a matrix to presenting multiple questions
...
1. Relatively cheap
    - Face-to-face paper-and-pencil: ~120 euro
...
3. Low effort respondents 
    ...
    - Use multiple attention checks: 2 attentions every 5 minutes [@agley_quality_2022]
